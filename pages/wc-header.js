            ...
            <div class="container relative z-[1] flex items-center justify-between md:justify-start h-full">
                ...
                <nav class="navTop hidden md:block">
                    <ul class="flex justify-start items-center">
                        <li class="text-white uppercase text-lg font-foco700 ">RELATÓRIO ANUAL ACHÉ</li>
                        <li><a href="#">PDF VERSÃO PDF</a></li>
                ...
                <span class="text-white uppercase text-base font-foco700 block md:hidden">RELATÓRIO ANUAL</span>
